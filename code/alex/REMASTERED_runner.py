...
idk = ax.plot_surface(
    ...
    label="String", vmin=0.0001, vmax=0.0008)
...
ax = plt.axes(projection='3d')
idk = ax.plot_surface(
    xx, yy, S_q_mean_nan, cmap="hsv", rstride=2, cstride=2, 
    shade=False, linewidth=0.05, antialiased=True, edgecolor="black", 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# np.save("../../data/PHASE_DOUBLE/X_q_mean", X_q_mean)
# np.save("../../data/PHASE_DOUBLE/C_q_mean", C_q_mean)
# np.save("../../data/PHASE_DOUBLE/S_q_mean", S_q_mean)
# np.save("../../data/PHASE_DOUBLE/par_range", par_range)
# np.save("../../data/PHASE_DOUBLE/q_vals", q_vals)
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
